...
You can then ssh to sdf-login01.slac.stanford.edu (or sdf-login02). The first time you login, a new home directory of 25GB will be created. You can then logout and follow the JupyterLab link below.
