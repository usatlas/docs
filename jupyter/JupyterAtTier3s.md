...
* [SLAC JupyterLab](https://ondemand-dev.slac.stanford.edu/public/doc/#/interactive-compute?id=jupyter) and [documents](SLACjupyter.md).
   * SLAC is migrating to a computing facility SDF. As a result, we recently made some change to the SLAC JupyterLab portal. If you haven't read and prepare yourself for "SLAC ID", please refer to [SDF: New SLAC ...](../README.md/#sdf:-new-slac-computing-environment-and-change-to-slac-computing-account) to estiblish your "SLAC ID", then ssh to sdf-login01.slac.stanford.edu for the first time.
